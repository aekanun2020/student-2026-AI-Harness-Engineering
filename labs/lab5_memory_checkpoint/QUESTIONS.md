...
**ผลรันจริงของทั้ง 3 คำสั่ง** (ดูภาพเต็มที่ [screenshots/labs/lab5_clearing_exercise4.png](../../screenshots/labs/lab5_clearing_exercise4.png)):

![ผลรัน tool-result clearing ของ Lab 5 ทั้ง 3 คำสั่ง](../../screenshots/labs/lab5_clearing_exercise4.png)

อ่านจากภาพ ไล่ตาม `[token] prompt=` ของแต่ละคำสั่ง:

| คำสั่ง | `[token] prompt=` | เกิดอะไรขึ้น |
| :-: | --- | --- |
| 1 | `939` → `9889` | อ่านไฟล์เสร็จ (`14,837 ตัวอักษร`) ทั้งไฟล์เข้าไปอยู่ใน history แล้ว |
| 2 | `9979` → `10046` | ยังแบกไฟล์อยู่ตลอด turn จนจบจึงขึ้น `[clear] … ประหยัด 14,837 ตัวอักษรใน history` |
| 3 | `1313` | เล็กลงเกือบ 8 เท่า แต่ `[answer] มี 7 Lab ครับ` ยังตอบถูก |

ในภาพนี้ไฟล์ `README.md` มีขนาด 14,837 ตัวอักษร ตอนคุณรันจะเป็นเลขอื่นที่ใหญ่กว่านี้ (ไฟล์โตขึ้นเรื่อยๆ)
— ที่ต้องเหมือนกันคือ prompt **พุ่งขึ้นแล้วตกลง** หลังบรรทัด `[clear]`
